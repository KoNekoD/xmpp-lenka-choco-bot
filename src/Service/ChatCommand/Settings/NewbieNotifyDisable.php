...
final readonly class NewbieNotifyDisable
    implements ChatCommandInterface
{
    ...
    public function run(ChatCommandData $data): ChatCommandResult
    {
        try {
            ...
            $data->chat->getConfiguration()->manage(newbieNotify: false);

            $text = 'Выключено оповещение о новых участниках чата в системе';
